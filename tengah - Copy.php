...
function validasi_pmdk(demo){
  if (demo.nama.value == ""){
    alert("Nama masih kosong");
    demo.nama.focus();
    return (false);
  }    
 if (demo.tempat_lahir.value == ""){
    alert("Tempat lahir masih kosong");
    demo.tempat_lahir.focus();
    return (false);
  }
  if (demo.alamat_asal.value == ""){
    alert("Alamat tinggal masih kosong");
    demo.alamat_asal.focus();
    return (false);
  }    
  if (demo.pos_asal.value == ""){
    alert("Kode pos tinggal masih kosong");
    demo.pos_asal.focus();
    return (false);
  }    
  if (demo.telp_rumah.value == ""){
    alert("Telp rumah masih kosong");
    demo.telp_rumah.focus();
    return (false);
  }    
  if (demo.hp.value == ""){
    alert("Ho HP masih kosong");
    demo.hp.focus();
    return (false);
  }
  if (demo.sma.value == ""){
    alert("Nama sekolah masih kosong");
    demo.sma.focus();
    return (false);
  } 
  if (demo.alamat_sma.value == ""){
    alert("Alamat sekolah masih kosong");
    demo.alamat_sma.focus();
    return (false);
  }   
  if (demo.pos_sma.value == ""){
    alert("Kode pos sekolah masih kosong");
    demo.pos_sma.focus();
    return (false);
  }                    
  if (demo.mat_4.value == ""){
    alert("Nilai matematika semester 4 masih kosong");
    demo.mat_4.focus();
    return (false);
  }                    
  if (demo.mat_5.value == ""){
    alert("Nilai matematika semester 5 masih kosong");
    demo.mat_5.focus();
    return (false);
  }                    
  if (demo.ing_4.value == ""){
    alert("Nilai bahasa inggris semester 4 masih kosong");
    demo.ing_4.focus();
    return (false);
  }                    
  if (demo.ing_5.value == ""){
    alert("Nilai bahasa inggris semester 5 masih kosong");
    demo.ing_5.focus();
    return (false);
  }                                      
  return (true);
...
function validasi_reguler(demo){
  if (demo.nama.value == ""){
    alert("Nama masih kosong");
    demo.nama.focus();
    return (false);
...
error_reporting(0);
 ...
 while ($data = mysql_fetch_array($hasil))
 {
   ...
   $query2 = "SELECT * FROM tr_kab WHERE id_prop = '$idProp'";
   $hasil2 = mysql_query($query2);
   $content = "document.getElementById('kabupaten').innerHTML = \"";
   while ($data2 = mysql_fetch_array($hasil2))
   {
       $content .= "<option value='".$data2['id']."'>".$data2['n_kab']."</option>";
   }
   $content .= "\"";
   echo $content;
   echo "}\n";
 ...
 // membaca semua propinsi
 $query1 = "SELECT * FROM tr_prop";
 $hasil1 = mysql_query($query1);

 // membuat if untuk masing-masing pilihan propinsi beserta isi option untuk combobox kedua
 while ($data1 = mysql_fetch_array($hasil1))
 {
   $idProp1 = $data1['id_prop'];

   // membuat IF untuk masing-masing propinsi
   echo "if (document.demo.propinsi1.value == \"".$idProp1."\")";
   echo "{";

   // membuat option kabupaten untuk masing-masing propinsi
   $query3 = "SELECT * FROM tr_kab WHERE id_prop = '$idProp1'";
   $hasil3 = mysql_query($query3);
   $content1 = "document.getElementById('kabupaten1').innerHTML = \"";
   while ($data3 = mysql_fetch_array($hasil3))
   {
       $content1 .= "<option value='".$data3['id']."'>".$data3['n_kab']."</option>";
   }
   $content1 .= "\"";
   echo $content1;
   echo "}\n";
...
<?php
$tahun = mysql_query("select * from tr_tahun where status='1'");
$r_tahun = mysql_fetch_array($tahun);
$gel = mysql_query("select * from t_gel where status='on'");
$r_gel = mysql_fetch_array($gel);
