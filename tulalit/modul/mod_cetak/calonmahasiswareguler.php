...
inner join t_daftar on t_daftar.kode_briva=t_calon_mahasiswa.i_registrasi
						...
						WHERE t_calon_mahasiswa.c_jalur = 'reguler' ORDER BY t_tempat_ujian.NamaTmp,t_calon_mahasiswa.n_lengkap ASC");
}
...
inner join t_daftar on t_daftar.kode_briva=t_calon_mahasiswa.i_registrasi
						INNER JOIN t_tempat_ujian ON t_calon_mahasiswa.i_temp_ujian = t_tempat_ujian.KodeTmp
						WHERE t_calon_mahasiswa.c_jalur = 'reguler' and t_daftar.pilihan='1' ORDER BY t_tempat_ujian.NamaTmp,t_calon_mahasiswa.n_lengkap ASC");
}
...
inner join t_daftar on t_daftar.kode_briva=t_calon_mahasiswa.i_registrasi
						INNER JOIN t_tempat_ujian ON t_calon_mahasiswa.i_temp_ujian = t_tempat_ujian.KodeTmp
						WHERE t_calon_mahasiswa.c_jalur = 'reguler' and t_daftar.pilihan='2' ORDER BY t_tempat_ujian.NamaTmp,t_calon_mahasiswa.n_lengkap ASC");
}
...
if ($pt=='all')
{
echo"<td><h3 align='center'>LAPORAN DATA CALON MAHASISWA REGULER POLTEKPOS DAN STIMLOG <BR />TAHUN ".date('Y')."</h3></td>";
}
elseif ($pt=='poltekpos' or $pt=='stimlog')
{
echo"<td><h3 align='center'>LAPORAN DATA CALON MAHASISWA REGULER ".strtoupper($pt)." <BR />TAHUN".date('Y')."</h3></td>";
}
?>
