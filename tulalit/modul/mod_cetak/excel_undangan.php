...
mysql_query("SET @i = 0");
$select = "SELECT @i := @i + 1 AS No, i_registrasi AS No_PIN_PMB, n_lengkap AS Nama_Calon_Mahasiswa, n_jns_kelamin AS Jenis_Kelamin, i_telp AS No_Telepon, i_hp AS No_HP, n_email AS Email FROM t_calon_mahasiswa WHERE c_jalur='undangan' ORDER BY i_registrasi ASC";
...
header("Content-Disposition: attachment; filename=CalonMahasiswaUNDANGAN_".date('d-M-Y').".xls");
