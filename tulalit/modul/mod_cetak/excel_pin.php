...
mysql_query("SET @i = 0");
$select = "SELECT @i := @i + 1 AS No, pin AS No_PIN_PMB, kd_aktivasi AS Kode_Aktivasi, status AS Status FROM t_pin ORDER BY pin ASC";
...
header("Content-Disposition: attachment; filename=PINExcel_".date('d-M-Y').".xls");
