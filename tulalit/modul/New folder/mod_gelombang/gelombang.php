  ...
  default:
    ...
    while($r=mysql_fetch_array($tampil)){
      echo "<tr class=menucell onMouseDown=pviiClassNew(this,'mousedown') onMouseOut=pviiClassNew(this,'menucell') onMouseOver=pviiClassNew(this,'mouseover')>
				...
				<td>$r[Ket]</td>";
		if($r[status]=="on") {
				echo"<td align=center ><img src='icon/aktif.png' height=15 weight=15></td>";
		} else {
				echo"<td align=center><img src='icon/nonaktif.jpg' height=15 weight=15></td>";
		}
	  echo"<td><a href=?module=gelombang&act=editgelombang&id=$r[Id]>Edit</a></td>
		        </tr>";
      $no++;
    }
    echo "</table>";
