...
$aksi="modul/mod_mhspmdk/mhspmdk.php";
switch($_GET[act]){
...
?>
	...
	<table>
	<a href="modul/mod_cetak/preview_pmdk.php" target="_blank">Print Preview</a> || <a href="modul/mod_cetak/excel_pmdk.php">Ekspor ke Excel</a>
	<tr><th>No</th><th>No.Registrasi</th><th>Nama Lengkap</th><th>Asal SMA</th><th>Status</th></th></tr>
<?php
$p = new Paging;
$batas = 10;
$posisi = $p->cariPosisi($batas);
$tampil = mysql_query("SELECT * FROM t_calon_mahasiswa WHERE c_jalur='pmdk' LIMIT $posisi,$batas");
$no = $posisi + 1;
...
?>
	...
	<td><a href='?module=pmdk&act=lihat_pmdk&id=<?=$r[i_registrasi]?>'><?=$r[i_registrasi]?></a></td>
	<td><?=$r[n_lengkap]?></td>
	<td><?=$r[n_sma]?></td>
	<?php
...
echo "<p>$linkHalaman</p>";
  ...
  case "lihat_pmdk":
    $edit = mysql_query("SELECT t_calon_mahasiswa.*,t_prop.*,t_kab.* FROM t_calon_mahasiswa
 			...
 			<tr>
  			...
  			<tr>
    			<tr><td colspan=2 align=center><input type=button value=Kembali onclick=self.history.back() style="cursor:pointer">
						<a href="?module=pmdk&act=update&id=<?=$r[i_registrasi]?>" style="text-decoration:none"><input type="button" value="Edit" style="cursor:pointer"></a></td></tr>
